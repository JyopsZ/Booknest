...
-- CUSTOMER
GRANT ALL PRIVILEGES ON bookstore.User_Balance TO 'customer'@'localhost';
GRANT ALL PRIVILEGES ON bookstore.User_Balance_Load TO 'customer'@'localhost';
...
GRANT SELECT ON bookstore.Products TO 'customer'@'localhost';
FLUSH PRIVILEGES;